...
const StartLogScreen: React.FC = () => {
  ...
  const handleRest = () => {
    ...
    const restCrisis: Omit<Crisis, 'id'> = {
      ...
      intensity: 2, // Intensidad baja por defecto al ser un aviso preventivo o de pausa
      localization: [],
      painQuality: [],
      symptoms: ['Fatiga'],
      medications: [],
    ...
    <div className="relative h-screen w-full flex flex-col bg-background-light dark:bg-background-dark shadow-2xl overflow-hidden">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 -mt-10">
        ...
        <div className="flex flex-col gap-6 w-full max-w-xs">
          {/* Registro Rápido */}
          <button 
            onClick={() => navigate('/crisis-details', { state: { isLite: true } })}
          ...
          {/* Registro Detallado */}
          <button 
            onClick={() => navigate('/crisis-details', { state: { isLite: false } })}

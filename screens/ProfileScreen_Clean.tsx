...
const ProfileScreen: React.FC = () => {
  ...
  const handleLogout = () => {
    if (confirm('┬┐Est├ís seguro de que quieres cerrar sesi├│n? Se borrar├ín todos tus datos locales.')) {
            ...
            >
              <div className="flex items-center gap-5">
                ...
                <div className="text-left">
                  <p className="text-sm font-bold text-slate-800 dark:text-white">An├ílisis Cl├¡nico</p>
              ...
              <div className="px-6 pb-8 pt-2 space-y-4 fade-in">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="p-5 bg-slate-50 dark:bg-background-dark/50 rounded-3xl border border-slate-100 dark:border-white/5">
                    <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-2">S├¡ntoma Com├║n</p>
